---
title: "t3.small 환경에서 무중단 배포 시 메모리 부족을 해결"
date: 2025-01-25 15:42:00
tags:
  - 회고
---

운영 서버(t3.small)에 Docker 기반 무중단 배포(Rolling Update)를 시도하는 과정에서, 신규 컨테이너와 기존 컨테이너가 공존하는 시점에 메모리와 CPU 사용량이 임계치를 초과(Overshooting)하는 현상 발생하고 있었다. 
