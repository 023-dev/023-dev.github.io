...
<ApiEndpoint method="POST" path="/pull-request">
```json
{
	"title": "PR 제목",
	"content": "PR 본문",
...
<ApiEndpoint method="POST" path="/pull-requests">
```json
{
	"title": "PR 제목",
	"content": "PR 본문",
...
<ApiEndpoint method="POST" path="/issues/{id}/assignee">
```json
{
	"assignees": ["john"]
}
...
<ApiEndpoint method="POST" path="/issues/{id}/label">
```json
{
	"labels": ["bug"]
}
